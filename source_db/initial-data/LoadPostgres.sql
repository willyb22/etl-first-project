...
COPY Calendar FROM '/initial-data/Calendar.txt'
...
COPY Campaigns FROM '/initial-data/Campaigns.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Customers FROM '/initial-data/Customers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY OrderLines FROM '/initial-data/OrderLines.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Orders FROM '/initial-data/Orders.txt'
...
COPY Products FROM '/initial-data/Products.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY Subscribers FROM '/initial-data/Subscribers.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' CSV;
...
COPY ZipCensus FROM '/initial-data/ZipCensus.txt'
...
COPY ZipCounty FROM '/initial-data/ZipCounty.txt'
    WITH HEADER NULL 'NULL' DELIMITER '	' ENCODING 'LATIN1'  CSV;
